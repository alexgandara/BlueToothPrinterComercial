...
/*****************************************************************************************************/	
	private void KeyListenerInit() {
		...
		btn_alfilPOS = (Button)findViewById(R.id.btn_alfilPOS);
		btn_alfilPOS.setOnClickListener(this);
	...
	private void Print_Test(){
		String lang = getString(R.string.strLang);
  		if((lang.compareTo("en")) == 0){
			String msg = "EN LINEA!\n\n";
			String data = "La Conexion entre su DispositivoAndroid y la Impresora ha sido  establecida.\n"
	                +"alfilPOS es una solucion de\nwww.factura.global" +
	                "\n\n\n\n\n";
